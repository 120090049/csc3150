    ...
    for (int i=0; i<process_list.size(); i++){
        ...
        if (pid != 1){
            for (int j=0; j<process_list.size(); j++){
                if (ppid == process_list[j].pid){
                    process_list[i].parent = &process_list[j];
                    break;
                }
            }
        }
        ...
        for (int j=0; j<process_list.size(); j++){
            if (pid == process_list[j].ppid){
                process_list[i].sons.push_back(&process_list[j]);
            }
        }
    }
}
    ...
    if(show_num){
        ...
        if (node->sons.empty()){
            ...
            for (int i=0; i<node->sons.size(); i++){
                if (i==0){
                    print_tree(node->sons[i], rec, 1, show_num);
                }
                else{
                    print_tree(node->sons[i], rec, 0, show_num);
                }
            }
        }
    }
